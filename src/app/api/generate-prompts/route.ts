...
- 每条提示词描述一个单一的静态画面，就像摄影师按下快门的那一瞬间
- 禁止动态叙述（"依次展现""从...到..."）
- 要具体：不要写"美丽的风景"，要写"雾气弥漫的竹林小径，晨光从竹叶缝隙洒下金色光斑，地面铺满潮湿的落叶"
- 要有层次：前景是什么、中景是什么、背景是什么
- 要有质感：材质、纹理、温度感（冰冷的金属、温润的木头、粗糙的石墙）
- 要有光影：光源方向、阴影形态、高光位置
- 结构：[视角/景别] + [画面主体及动作] + [场景环境细节] + [光影描述] + [色调氛围] + [风格质感]
- 提示词以中文输出

以 JSON 数组返回，每个元素：
- id: 段落ID
- prompt: 提示词（80-150字，具体、有画面感、有层次）
